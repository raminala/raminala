...
Dataset divided to train-test parts, 80% for training and 20% for testing the generated model.

```{r Splitting, paged.print=TRUE}
set.seed(20)
...
Carat package is used to generate random forest model.
