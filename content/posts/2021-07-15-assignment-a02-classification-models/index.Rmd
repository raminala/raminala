...
status_predictions_SLR <- predict(mdl_bank_S, new_data = bank)
status_predictions_MLR <- predict(mdl_bank_M, new_data = bank)
...
conf_mat(status_predictions_model_LOOCV, truth = subscription_status,
    estimate = status_pred)
```
