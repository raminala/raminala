...
univariate assignment is about deciding, or in a better term predicting, about the price of a diamond based on available data. Since prediction would be done on a quantitative variable (price), it considers as a *regression problem*. Here, we will solve the problem using *linear fitting* to avoid over fitting. 
...
## Bivariate Analysis: price considering both carat and clarity
...
## Three variaable Analysis: price considering carat, colour, and clarity
